...
public class MySharepreferenceUtil {
    ...
    public MySharepreferenceUtil(Context context) {
        this(context, ConfigUtils.PREFERENCE_DEFAULT_NAME, Context.MODE_PRIVATE);
    }

    public MySharepreferenceUtil(Context context, String preferenceName) {
        this(context, preferenceName, Context.MODE_PRIVATE);
    }


    public MySharepreferenceUtil(Context context, String preferenceName, int mode) {
...
//    }
    ...
    public <T> void putModel(String key, T t) {
        if (!TextUtils.isEmpty(key) && t != null) {
            putString(key, new Gson().toJson(t));// fastjson
        }
    }
    ...
    public <T> T getModel(String key, Class<T> clazz) {
        ...
        return TextUtils.isEmpty(value) ? null : (new Gson().fromJson(value,clazz));// fastjson
    }
    ...
    public void selectKeyAll() {
        ...
        for (String key : map.keySet()) {
            CCLog.e("key= " + key + " and value= " + map.get(key));
        }
    }
}
